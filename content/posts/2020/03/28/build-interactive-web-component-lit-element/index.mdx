...
![Initializing an npm project](/images/initialize-npm-package.jpg)
...
![Our simple Hello World component in the browser](/images/hello-world-web-component.jpg)
...
![Accordion with panel component](/images/accordion-panel-with-static-content.jpg)
...
![The accordion with a custom property set at `:root`](/images/accordion-with-custom-border-property.jpg)
